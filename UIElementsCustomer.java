 ...
 * @author Sandeep
 */
public class UIElementspage extends javax.swing.JFrame {

    /**
     * Creates new form Feedbackpage
     */
    public UIElementspage() {
        initComponents();
    }
public void close(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIElementspage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UIElementspage().setVisible(true);
            }
        });
    }
